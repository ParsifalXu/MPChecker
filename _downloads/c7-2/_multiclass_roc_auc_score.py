def _multiclass_roc_auc_score(
    ...
    average : {'micro', 'macro', 'weighted'}
        ...
        metric scores. For multiclass targets, `average=None` is only
        implemented for `multiple_class='ovo'` and `average='micro'` is only
    ...
    if average is None:
        if multi_class == "ovo":
            ...
            raise NotImplementedError(
                "average=None is not implemented for multi_class='ovr'."
            )
